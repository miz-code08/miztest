const questions = [
    ...
    "Cho các nhận định sau: Nhận định nào đúng khi nói về vai trò của trao đổi chất và chuyển hóa năng lượng?",
    ...
    "Khi nói về mối quan hệ giữa trao đổi chất và chuyển hóa năng lượng ở cấp tế bào và cơ thể, có mấy phát biểu sau đây đúng?",
...
const answers = [
    ...
    ["A. Sự chuyển hóa của sinh vật.", "B. Có vai trò quan trọng đối với sự biến đổi các chất.", "C. Sự trao đổi năng lượng.", "D. UĐ sự sống của sinh vật.", 3],
    ["A. 2.", "B. 3.", "C. 1.", "D. 4.", 1],
    ...
    ["A. Quá trình trao đổi chất và cảm ứng.", "B. Quá trình trao đổi chất và sinh sản.", "C. Quá trình chuyển hóa năng lượng.", "D. Quá trình trao đổi chất và cảm ứng.", 1],
    ...
    ["A. Qua dòng mạch rây theo chiều từ trên xuống.", "B. Qua dòng mạch gỗ sang mạch rây.", "C. Từ mạnh rây sang mạch gỗ.", "D. Qua dòng mạch gỗ.", 3],
