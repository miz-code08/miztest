const questions = [
    ...
    "Hệ sắc tố quang hợp ở cây xanh bao gồm những",
    ...
    "Những phát biểu nào sau đây đúng khi nói về vai trò của hô hấp đối với cơ thể thực vật? <br>1.Năng lượng (ATP) sinh ra từ hô hấp được sử dụng cho hầu hết các hoạt động sống của cây như tổnghợp và vận chuyển các chất, sinh trưởng và phát triển, cảm ứng,… <br>2.Nhiệt năng được giải phóng ra trong hô hấp giúp duy trì nhiệt độ cơ thể, đảm bảo cho các hoạt động sống trong cơ thể thực vật diễn ra một cách bình thường. <br>3.Các sản phẩm trung gian được tạo ra từ quá trình hô hấp ở thực vật (đường 3 carbon, pyruvate,…) là nguyên liệu để tổng hợp nên các hợp chất hữu cơ trong cơ thể như protein, acid béo,… <br>4.Cung cấp nguồn thức ăn cho sinh vật dị dưỡng và là nguồn nguyên liệu cho sản xuất công nghiệp, chế biến dược phẩm của con người; cung cấp năng lượng, điều hoà không khí.",
    "Khi nói về ảnh hưởng của các nhân tố môi trường đến quá trình hô hấp hiếu khí ở thực vật, phát biểu nào sau đây sai?",
    // "",
];
...
const answers = [
    ...
    ["A. (1), (2) và (3).", "B. (2), (3) và (4).", "C. (1), (2) và (4).", "D. (1), (3) và (4).", 0],
    ["A. Nhiệt độ.", "B. Nồng độ khí CO2.", "C. Nồng độ khí Nitơ (N2).", "D. Hàm lượng nước.", 2],
    ["A. Hàm lượng nước tỉ lệ nghịch với cường độ hô hấp.", "B. Cường độ hô hấp và nhiệt độ tỉ lệ thuận với nhau.", "C. Nồng độ CO2 cao sẽ ức chế hô hấp.", "D. Nồng độ CO2 thấp sẽ ức chế hô hấp.", 2],
    ["A. Hàm lượng nước tỉ lệ thuận với cường độ hô hấp.", "B. Cường độ hô hấp và nhiệt độ luôn tỉ lệ thuận với nhau.", "C. Nồng độ CO2 cao sẽ ức chế hô hấp.", "D. Vượt qua nhiệt độ tối ưu thì cường độ hô hấp giảm.", 1],
    ...
    ["A. Cung cấp năng lượng chống chịu.", "B. Tăng khả năng chống chịu.", "C. Tạo ra sản phẩm trung gian.", "D. Miễn dịch cho cây.", 2],
